...
#ifndef MACE_FLOWS_CPU_CPU_REF_FLOW_H_
#define MACE_FLOWS_CPU_CPU_REF_FLOW_H_
...
class CpuRefFlow : public CommonFp32Flow {
 public:
  explicit CpuRefFlow(FlowContext *flow_context);
  virtual ~CpuRefFlow() = default;
 ...
 private:
  MACE_DISABLE_COPY_AND_ASSIGN(CpuRefFlow);
};

}  // namespace mace

#endif  // MACE_FLOWS_CPU_CPU_REF_FLOW_H_
